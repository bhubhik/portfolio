    ...
    <div className={classes.card}>
      <section>
        ...
        <p>
          ...
          return and start working for a bank, but as I said, decisions change.
          I knew the basics of computer science and programming from my diploma
          so, I pursued to become a frontend developer and I also got my degree
          along the way. I started taking online courses and started building
          websites and learned many exciting new kinds of stuff, and I{`'`}m{' '}
